...
#stderr: You can reassign these variables in order to redirect the output of your code to a file other than stdout
# to keep a log of your program's output or make code "shut up", i.e. not send output to stdout.
stderr = sys.stderr #interpreters standard error stream
sys.stderr = open(os.devnull, 'w')
import dgl
sys.stderr.close()
sys.stderr = stderr #store errors in os.devnull
